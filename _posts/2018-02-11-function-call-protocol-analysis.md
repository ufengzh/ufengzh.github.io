...
![@图1：x86寄存器](/assets/img/x86-registers.png)
...
[@图2：子程序调用栈](/assets/img/subroutine-call-stack.png)
...
![@图3：准备参数栈变化](/assets/img/prepare-stack-args.png)
...
![@图4：调用子程序栈变化](/assets/img/invoke-subroutine-stack.png)
...
![@图5：分配栈空间&执行子程序体栈变化](/assets/img/alloc-stack-execute.png)
...
![@图6：子程序释放栈空间栈变化](/assets/img/release-stack.png)
...
![@图7：被调者执行返回栈变化](/assets/img/caller-return-code.png)
...
![@图8：调用者移除调用参数栈变化](/assets/img/caller-remove-args.png)
